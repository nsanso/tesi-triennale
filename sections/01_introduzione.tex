...
\begin{itemize}
	...
	\item Calcolo della velocità dalla posizione con correzione del rumore
...
Nel capitolo \ref{sec:velocita} è descritta la soluzione scelta per l'acquisizione della velocità dalla posizione, con correzione del rumore.
